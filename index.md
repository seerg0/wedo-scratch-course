...
<ul class="lesson-list">
  <li>
    <a href="0_формат_курса.html">📋 Формат курса</a>
    <p>Описание структуры и формата занятий</p>
  </li>
  <li>
    <a href="1_сигнализация_wedo.html">🚨 Урок 1: Сигнализация (WeDo)</a>
    <p>Создаем сигнализацию с датчиком движения на LEGO WeDo</p>
  </li>
  <li>
    <a href="2_сигнализация_scratch.html">💻 Урок 2: Сигнализация (Scratch)</a>
